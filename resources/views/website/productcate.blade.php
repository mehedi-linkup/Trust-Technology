...
<section class="pager" style="background-image: linear-gradient(rgba(3, 1, 10, 0.5), rgba(3, 1, 10, 0.5)), url({{ '../../'. $backimage->product }});">
    <div class="container pager-text py-5">
        <h3 class="text-center text-white fw-bold">{{ $productcat->name }} </h3>
    </div>
</section>
    <section class="py-4 mt-3 product">
        <div class="container">
            <div class="row mt-3">
                ...
                {{-- <div class="col-lg-2 col-md-3 col-12 long-category">
                    ...
                    <div class="product-panel">
                        ...
                        <aside>
                            <div class="post-category-widget">
                                <ul>
                                    @foreach($category as $item)
                                    <li class="{{ $productcat->id == $item->id ? 'active' : '' }}">
                ...
                <div class="col-md-9 col-12">
                    ...
                    <div class="row">
                        @if(count($productcat->product) > 0)
                            @foreach ($productcat->product as $item) 
                            <div class="col-12 col-md-3 text-center mb-4">
                                <div class="card gallery-image">
                                    <a href="{{route('product.details',$item->id)}}"><img src="{{ asset($item->image) }}" alt="" title="{{ $item->title }}" /></a>
                                </div>
