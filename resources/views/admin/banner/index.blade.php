        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
              ...
              @endif
                  ...
                  @endif
                    <h4 class="heading"><i class="fas fa-sliders-h"></i></i> Add Slider</h4>
                    <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <span>image size resulation (1350 * 500)</span>  
                                @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            @forelse ($banner as $key=>$item)
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a class="btn btn-sm  btn-primary" href="{{ route('banner.edit', $item->id) }}"><i class="fas fa-pencil-alt"></i></a>
                                        <button type="submit" class="btn btn-danger p-1" onclick="deleteUser({{ $item->id }})"><i class="far fa-trash-alt"></i></button>
                                        <form id="delete-form-{{ $item->id }}" action="{{ route('banner.destroy', $item) }}"
